        ...
        function (require, module, exports) {
          ...
          var PreflightTest = (function (_super) {
            ...
            PreflightTest.prototype._getRTCStats = function () {
              var firstMosSampleIdx = this._samples.findIndex(
                function (sample) {
        ...
        function (require, module, exports) {
          ...
          var PStream = (function (_EventEmitter) {
            ...
            function PStream(token, uris, options) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (PStream.__proto__ || Object.getPrototypeOf(PStream)).call(
                  this,
                ),
              );
        ...
        function (require, module, exports) {
          ...
          MockRTCStatsReport.fromRTCStatsResponse =
            function fromRTCStatsResponse(statsResponse) {
              ...
              var statsMap = statsResponse.result().reduce(function (
                map,
                report,
              ) {
                var id = report.id;
        ...
        function (require, module, exports) {
          ...
          function getRTCIceCandidateStatsReport(peerConnection) {
            return getRTCStatsReport(peerConnection).then(function (report) {
              ...
              var selectedCandidatePairReport = candidatePairs.find(
                function (pair) {
                  return (
                    pair.selected ||
        ...
        function (require, module, exports) {
          ...
          var StatsMonitor = (function (_super) {
            ...
            StatsMonitor.prototype._getSample = function () {
              var _this = this;
              return this._getRTCStats(this._peerConnection).then(
                function (stats) {
